...
%
%% Output arguments
% radInterpFilt- The desired filter of [ceil(r), ceil(r), p] dimentions, with relevant pixels
%   carrying values used for LBP calculation, including interpolation for cases when point falls
%   between pixels.
%
%% Issues & Comments
% - Increase in r, results in larger filter support causing computaional burded and slower urn time.
%
%% Example
